...
Proof.
  apply T_Abs. apply T_Var. unfold update. reflexivity.  Qed.
...
Example typing_nonexample_3 :
  ~ (exists S T,
        empty |-
          ...
          T).
Proof.
  unfold not. intros [s [T H]].
  inversion H; subst.
  inversion H5; subst.
  inversion H3; subst.
  inversion H6; subst.
  unfold update in H2. unfold update in H4.
  rewrite H2 in H4. inversion H4.
  symmetry in H1. apply no_infinite_nested_type.
