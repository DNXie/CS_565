...
Proof.
  ...
  induction H1; subst; intros y2 H2.
  - inversion H2; subst.
    + reflexivity.
    + inversion H3.
    + inversion H4.
...
Proof.
  ...
  intros contra. destruct contra as [t' H1].
...
Proof.
  ...
  - left. apply v_tru.
  - left. apply v_fls.
  - right. destruct IHt1 as [IHt1 | IHt1].
    + inversion IHt1; subst. 
      * exists t2. apply ST_IfTrue.
      * exists t3. apply ST_IfFalse.
    + destruct IHt1 as [t' IHt1]. exists (test t' t2 t3).
...
Inductive step : tm -> tm -> Prop :=
  ...
  | ST_If : forall t1 t1' t2 t3,
      ...
      test t1 t2 t3 --> test t1' t2 t3
  (* FILL IN HERE *)
  | ST_IfBrTrue: forall b,
      test b tru tru --> tru
  | ST_IfBrFalse: forall b,
      test b fls fls --> fls
...
Proof.
  intros e t st stk1. induction e; simpl.
  - apply multi_R. simpl.
Admitted.
